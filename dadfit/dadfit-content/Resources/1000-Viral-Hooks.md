...
- The (insert thing) you have now in your (insert age group) is so (insert noun).
...
- It's okay if you mom didn't talk to you about
...
- Here's a quick what to (insert result) (insert metric) of your (insert noun) legally.
...
- Before you ever take your (insert living thing) on a (insert action) for the first time you need to watch this.
...
- You want your (insert noun) to look like these? So did this guy.
...
- If you (insert action) but don't know when to (insert action). You could be losing up to (insert metric) of your (insert dream result) without even realizing it.
...
- So you want to impress your (insert person) when you (insert action) this (insert upcoming time).
...
- What would happen to your (insert noun) if you only (insert action) for an entire week.
...
- Here is a tier list of the best (insert noun) sources based off of how good they are for your (insert noun).
...
- F*ck it, I am going to roll # of (insert noun) in 60 seconds.
- This is what a full (insert time) (insert action) looks like at top # (insert school) in (insert location).
- What's homies, I am going to give you a crash course of what (insert noun) to ask for, based on what you want that (insert noun) to do for you.
...
- It has taken me # years of (insert occupation/skill/hobby) to realize I have been (insert action) wrong this entire time.
- Remember (insert method/strategy name) for your next (insert noun).
- Remember (insert #) (insert noun) combo for your next (insert noun).
...
- Both groups gained the same amount of (insert noun). Except this group (insert action) # days a week, and this group (insert action) #.
...
- If you are (insert action) just once per (month/day/year) than you are f*cked.
- This is me when I (insert action) (insert frequency), and this is me still (insert action) (insert frequency).
- No your (insert noun) is not causing (insert result).
...
- I have (insert amount of thing), (insert amount of time), and a pipe dream to get ready for (insert event).
...
- This week in fatherhood/motherhood I am pleased to report that I (insert result).
