...
- [Tulu 3 blog post (AllenAI)](https://allenai.org/blog/tulu-3) — Extended discussion of data decisions not fully covered in the paper.
...
- [TimescaleDB documentation — hyperfunctions](https://www.tigerdata.com/docs//use-timescale/latest/hyperfunctions/) — Reference for TimescaleDB-specific SQL constructs.
