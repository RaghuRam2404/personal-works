...
- [A Survey of Preference-Based Reinforcement Learning Methods](https://huggingface.co/blog/pref-tuning) — HuggingFace blog. The most comprehensive recent survey. Places all 6 methods in context.
- [DPO vs KTO vs SimPO: Practical Comparison](https://kaitchup.substack.com/p/orpo-preference-optimization-without) — The Kaitchup. Applied perspective on which method to choose in practice.
