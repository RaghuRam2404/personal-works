...
- [RunPod — Getting started guide](https://docs.runpod.io/get-started) — Official RunPod setup documentation.
...
- [LIMA: Less Is More for Alignment (Zhou et al. 2023)](https://arxiv.org/abs/2305.11206) — Examines whether CPT and SFT are complementary for alignment.
