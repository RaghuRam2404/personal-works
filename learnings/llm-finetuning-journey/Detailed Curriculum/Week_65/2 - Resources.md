...
[GPTQ: Accurate Post-Training Quantization for Generative Pre-trained Transformers](https://arxiv.org/abs/2210.17323) — Frantar et al., 2022. The foundational 4-bit weight quantization method underlying many GGUF Q4 variants you will run via llama.cpp.

[AWQ: Activation-aware Weight Quantization for LLM Compression and Acceleration](https://arxiv.org/abs/2306.00978) — Lin et al., 2023. Activation-aware low-bit quantization; understand why some GGUF quants preserve quality better than others on outlier-heavy layers.

[llama.cpp: Efficient LLM Inference in C/C++ (project README)](https://github.com/ggml-org/llama.cpp/blob/master/README.md) — Comprehensive build instructions, backend options, and performance notes including Metal.
...
[Ollama Modelfile Reference](https://docs.ollama.com/modelfile) — Official spec for all Modelfile directives: FROM, PARAMETER, SYSTEM, TEMPLATE, MESSAGE.

[Ollama OpenAI Compatibility](https://docs.ollama.com/openai) — Documents which OpenAI API endpoints Ollama supports and what parameters are accepted.
...
[ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) — Source; build instructions in `docs/build.md`; grammar files in `grammars/` including `sql.gbnf`.
...
[llama.cpp GBNF Grammar Guide](https://github.com/ggml-org/llama.cpp/blob/master/grammars/README.md) — How to write grammar files to constrain output to SQL or any other formal language.
