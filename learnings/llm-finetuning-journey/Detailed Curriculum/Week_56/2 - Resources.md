...
- [SeSQL: Yet Another Large-scale Session-level Chinese Text-to-SQL Dataset](https://arxiv.org/abs/2208.12711) — Larger multi-turn dataset; useful for understanding the format.
...
- [Defog blog — multi-turn SQL models](https://defog.ai/blog/) — Practical experience with conversational SQL fine-tuning.
...
- [TimescaleDB time_bucket_gapfill](https://www.tigerdata.com/docs//api/latest/hyperfunctions/gapfilling/time_bucket_gapfill/) — Reference for the most common multi-turn refinement in TimescaleDB.

## Optional / Bonus

- [Pitfalls in Language Models for Code Intelligence: A Taxonomy and Survey](https://arxiv.org/abs/2310.17903) — Work on implicit reference resolution in code tasks; similar challenges to implicit SQL context.
