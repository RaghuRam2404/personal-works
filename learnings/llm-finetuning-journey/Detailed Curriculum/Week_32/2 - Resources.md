...
- [QLoRA: Efficient Finetuning of Quantized LLMs (paper walkthrough)](https://www.youtube.com/watch?v=TPcXVJ1VSRI) — Yannic Kilcher — ~52 min. Walk-through of NF4, double quantization, and paged optimizers; the clearest video companion to the QLoRA paper.
- [A Visual Guide to Quantization for LLMs](https://www.youtube.com/watch?v=mNE_d-C82lI) — Maarten Grootendorst — ~25 min. Visual companion to the blog post; covers symmetric vs asymmetric, INT8, GPTQ, and AWQ side-by-side.
- [LLM.int8() and Emergent Features](https://www.youtube.com/watch?v=jyOqtw4ry2w) — Tim Dettmers — ~57 min. The LLM.int8() author explains outlier features and why naive INT8 fails above 6.7B parameters.
