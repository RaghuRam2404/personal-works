...
[Weights & Biases — Comparing Runs Across Experiments](https://docs.wandb.ai/models/app/features/panels/run-comparer) — How to use W&B's comparison view to overlay loss curves and metrics across your four model runs.
...
[ggml-org/llama.cpp — Model Support Matrix](https://github.com/ggml-org/llama.cpp/blob/master/README.md) — Verify that your candidate models (Gemma 2, Llama 3.1, DeepSeek-R1-Distill) are supported for downstream GGUF conversion.
