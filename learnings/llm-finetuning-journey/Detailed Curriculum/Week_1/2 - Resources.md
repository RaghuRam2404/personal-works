...
- [Automatic Differentiation in Machine Learning: a Survey (Baydin et al. 2018)](https://arxiv.org/abs/1502.05767) — Sections 1–3 give the cleanest exposition of forward-mode vs reverse-mode autodiff. Read after the micrograd video if you want to know exactly what PyTorch's autograd is doing under the hood.
- [The Matrix Calculus You Need For Deep Learning (Parr & Howard 2018)](https://arxiv.org/abs/1802.01528) — Self-contained derivation of vector and matrix gradients used throughout the rest of the course. Sections 3–5 are the operationally important ones for backprop with tensors.
