...
[Thinking about High-Quality Human Data (Lilian Weng)](https://lilianweng.github.io/posts/2024-02-05-human-data-quality/) — Covers data quality, annotator agreement, and how human-data choices propagate into evaluation reliability.

[The Hitchhiker's Guide to Testing Statistical Significance in NLP (Dror et al. 2018)](https://arxiv.org/abs/1809.01448) — When to use hypothesis testing, which test to pick, how to compute CIs, and why most NLP papers skip this (and when that is acceptable).
