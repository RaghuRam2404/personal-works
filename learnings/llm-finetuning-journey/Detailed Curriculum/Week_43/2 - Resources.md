...
- [RLHF vs DPO vs GRPO: An Overview](https://huggingface.co/blog/pref-tuning) — HuggingFace. Places DPO in context with the broader alignment landscape.
- [Understanding DPO](https://cameronrwolfe.substack.com/p/direct-preference-optimization) — Technical notes with step-by-step math. Alternative exposition if the paper's notation is unclear.
