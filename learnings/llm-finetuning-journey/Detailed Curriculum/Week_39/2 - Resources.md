...
[How We Evaluate Text-to-SQL Models at Defog](https://defog.ai/blog/) — Defog AI blog. Explains the design decisions behind their evaluation harness, including result set normalization and safety filtering.

[FLEX: Expert-level False-Less EXecution Metric for Reliable Text-to-SQL](https://arxiv.org/abs/2409.19014) — Kim et al., 2024. Quantifies the false-positive and false-negative rate of plain Execution Accuracy on Spider/BIRD and motivates richer evaluation; the failure-mode analysis is directly applicable to your harness.
...
[How We Went All In on sqlc/pgx for Postgres + Go](https://brandur.org/sqlc) — Brandur Leach. Practical post on robust Postgres tooling patterns that informs the schema isolation approach used in test harnesses.
