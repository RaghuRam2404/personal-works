...
- [Unsloth notebooks](https://github.com/unslothai/notebooks) — Pre-made Colab notebooks for Qwen2.5, Llama 3, and other models; good starting points for your training setup.
