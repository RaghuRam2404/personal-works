...
- [RLHF: From Zero to ChatGPT](https://huyenchip.com/2023/05/02/rlhf.html) — Chip Huyen. High-level narrative of the RLHF landscape. Good complement to the technical paper.

## GitHub Repos

- [TRL PPOTrainer source](https://huggingface.co/docs/trl/ppo_trainer) — HuggingFace TRL. The file you are annotating this week. Use `git blame` to find when specific lines were added; the commit messages often explain the design choices.
...
- [Trust Region Policy Optimization (TRPO)](https://arxiv.org/abs/1502.05477) — Schulman et al. 2015. The predecessor to PPO using second-order optimization. Understanding TRPO makes PPO's motivation clearer.
