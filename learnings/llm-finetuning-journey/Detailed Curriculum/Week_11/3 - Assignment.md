...
- Obtain a SQL corpus. Two options:
  - Option A (recommended): Download Spider dataset's training SQL queries (only the SQL field, not the natural language). Available at [Yale Spider dataset](https://yale-lily.github.io/spider). Extract ~10,000 SQL queries.
