...
- [OpenAI API cookbook — async parallelism](https://github.com/openai/openai-cookbook/blob/main/examples/api_request_parallel_processor.py) — Exact pattern for async batch generation with rate limiting.
...
- [Hamel Husain — Generating SQL training data](https://hamel.dev/notes/dbt/) — Domain-specific synthetic SQL generation walkthrough.
...
- [TimescaleDB SQL reference](https://www.tigerdata.com/docs//api/latest/) — Ground truth for all TimescaleDB function signatures.
...
- [What Makes Good Data for Alignment? (DEITA)](https://arxiv.org/abs/2312.15685) — Automated complexity and quality scoring of generated data; could replace manual difficulty specification.
