...
- [How to Fine-Tune LLMs with Unsloth: Step-by-Step](https://unsloth.ai/docs/get-started/fine-tuning-llms-guide) — Unsloth blog. Official walkthrough; reference during your training run.
- [Understanding Your Training Metrics](https://wandb.ai/fully-connected/articles/understanding-your-training-metrics) — W&B blog. Guide to interpreting training loss curves, gradient norms, and eval metrics.

## GitHub Repos

- [Unsloth notebooks](https://github.com/unslothai/notebooks) — Find the Qwen2.5 notebook; adapt it to your dataset.
...
- [HuggingFace model tags](https://huggingface.co/docs/hub/models-the-hub) — How to tag your model for discoverability (`text2sql`, `postgresql`, etc.)
