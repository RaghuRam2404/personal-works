...
For this week, use 1K examples from a publicly available text-to-SQL dataset such as [Spider](https://yale-lily.github.io/spider) or [sql-create-context](https://huggingface.co/datasets/b-mc2/sql-create-context) on HuggingFace. Both are small enough to download on Colab Free. Filter for PostgreSQL-compatible queries where possible.
