...
- [Spider dataset](https://yale-lily.github.io/spider) — Cross-domain text-to-SQL benchmark; good for diverse schemas.
- [wikisql](https://huggingface.co/datasets/Salesforce/wikisql) — Simpler SQL dataset; good for quick prototyping but limited to single-table queries.
