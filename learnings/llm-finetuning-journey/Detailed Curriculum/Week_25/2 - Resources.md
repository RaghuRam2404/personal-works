...
- [A Beginner's Guide to LLM Fine-Tuning](https://mlabonne.github.io/blog/posts/A_Beginners_Guide_to_LLM_Finetuning.html) — Maxime Labonne. Walks through the full QLoRA fine-tuning loop on a code dataset; the dataset-format and training-config sections directly inform your Spider SFT pipeline.
...
- [bird-bench/mini_dev](https://github.com/bird-bench/mini_dev) — BIRD mini-dev set; smaller subset for rapid iteration.
