...
[sqlglot Dialect Docs](https://sqlglot.com/sqlglot/dialects.html) — The parser used for SQL validity checking in Criterion 3. PostgreSQL dialect is `"postgres"`.
...
[Sebastian Raschka — Understanding Large Language Model Training (magazine.sebastianraschka.com)](https://magazine.sebastianraschka.com/p/understanding-large-language-models) — Covers pretraining mechanics, data pipelines, and tokenization at a depth appropriate for Phase 3 gate review.
...
[Chinchilla Replication (Epoch AI)](https://epoch.ai/blog/chinchilla-scaling-a-replication-attempt) — Independent verification of Chinchilla scaling predictions. Useful if you want to stress-test your understanding of Criterion 4.

---

## Optional / Bonus

[LoRA: Low-Rank Adaptation of Large Language Models (Hu et al. 2022)](https://arxiv.org/abs/2106.09685) — If you want to read ahead, this is the core LoRA paper you will study in Week 30. Read only after you have completed your gate evidence collection.

[Chinchilla Replication (Epoch AI blog post)](https://epoch.ai/blog/chinchilla-scaling-a-replication-attempt) — An independent verification of Chinchilla scaling predictions. Useful if you want to stress-test your understanding of Criterion 4.
