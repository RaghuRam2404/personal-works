...
- [Tensor Programs V: Tuning Large Neural Networks via Zero-Shot Hyperparameter Transfer (MuP)](https://arxiv.org/abs/2203.03466) — Yang et al. 2022. Why hyperparameters don't transfer across model sizes; context for your hyperparameter choices.
...
- [Training Neural Networks: A Road to Hell](https://www.ruder.io/deep-learning-nlp-best-practices/) — Sebastian Ruder. Classic blog post on training instabilities and debugging.
