...
[Simon Willison — The ReAct Pattern for LLM Tools](https://simonwillison.net/2023/Mar/17/react-pattern/) — Clear explanation of the loop mechanics; useful mental model before implementing your own.

[Modal — Running PostgreSQL in a Serverless Function](https://modal.com/docs/examples/db_to_sheet) — If you need a cloud-hosted PostgreSQL for your agentic loop instead of local.
