...
- [Policy Gradient Methods for Reinforcement Learning with Function Approximation](https://proceedings.neurips.cc/paper/1999/file/464d828b85b0bed98e80ade0a5c43b0f-Paper.pdf) — Sutton et al. 1999. The original policy gradient theorem paper (NeurIPS PDF). Read the theorem statement and proof (2 pages).
- [Asynchronous Methods for Deep Reinforcement Learning (A3C)](https://arxiv.org/abs/1602.01783) — Mnih et al. 2016. Read Sections 3–4; introduces the actor-critic policy-gradient setup that motivates the baseline-subtracted REINFORCE you implement in CartPole.
- [High-Dimensional Continuous Control Using Generalized Advantage Estimation (GAE)](https://arxiv.org/abs/1506.02438) — Schulman et al. 2015. Read Section 3 only; introduces the variance-reduction technique you will use heavily starting in Week 42 with PPO.
...
- [RL from Human Feedback: From Zero to chatGPT](https://huyenchip.com/2023/05/02/rlhf.html) — Chip Huyen. High-level overview of how RL connects to RLHF. Good orientation for where Phase 5 is heading.
