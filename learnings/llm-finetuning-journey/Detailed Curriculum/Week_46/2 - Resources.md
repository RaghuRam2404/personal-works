...
- [GRPO: A Simple Alternative to PPO](https://huggingface.co/blog/garg-aayush/grpo-from-scratch) — HuggingFace blog. Concise overview with code examples.
- [Understanding DeepSeek-R1 and its Surprising Emergent Reasoning](https://www.interconnects.ai/p/crafting-a-good-reasoning-model) — Nathan Lambert. Analysis of why RLVR produces reasoning chains.
...
- [Open-Reasoner-Zero](https://github.com/Open-Reasoner-Zero/Open-Reasoner-Zero) — Open-source replication of DeepSeek-R1's RLVR training. Study for reference.
...
- [STILL-2 / Imitate, Explore, and Self-Improve](https://arxiv.org/abs/2412.09413) — Process reward models combined with GRPO. Relevant if you want to reward intermediate reasoning steps in SQL.
