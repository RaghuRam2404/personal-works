...
- [Lessons from the Trenches on Reproducible Evaluation of Language Models](https://arxiv.org/abs/2405.14782) — Gao et al. 2024. The paper behind the tool you are using this week.
...
- [Benchmark Data Contamination of Large Language Models: A Survey](https://arxiv.org/abs/2406.04244) — Xu et al., 2024. Survey of how training data leaks into benchmarks, detection methods, and mitigation strategies; required reading before you trust any leaderboard number this week.
- [What's in MMLU?](https://github.com/EleutherAI/lm-evaluation-harness) — EleutherAI. Discussion of MMLU's strengths and limitations.
...
- [lm-eval task list](https://github.com/EleutherAI/lm-evaluation-harness/blob/main/lm_eval/tasks/README.md) — Full list of available tasks. Browse before choosing what to run.
