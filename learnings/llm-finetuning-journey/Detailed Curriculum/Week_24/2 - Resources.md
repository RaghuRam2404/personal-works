...
- [Nathan Lambert's post on open LLM training recipes](https://www.interconnects.ai/p/the-data-wall) — Interconnects. Survey of what is and is not disclosed in modern LLM technical reports.
