...
[Hugging Face AWQ Blog Post](https://huggingface.co/docs/transformers/en/quantization/awq) — Covers AutoAWQ installation, quantization config options, and throughput benchmarks on various GPU types.
...
[ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) — Build instructions in `docs/build.md`; quantization types table in `docs/quantization.md`.
...
[llama.cpp quantization types reference](https://github.com/ggml-org/llama.cpp/blob/master/tools/quantize/README.md) — Official table of Q-types with perplexity benchmarks on Llama models; use to interpret your own measurements.
...
[imatrix quantization (llama.cpp)](https://github.com/ggml-org/llama.cpp/blob/master/tools/imatrix/README.md) — Importance-matrix guided quantization for GGUF; improves Q4 accuracy by 0.3–0.8 pp with a calibration pass; good stretch goal.
