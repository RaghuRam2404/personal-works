...
- [Towards Monosemanticity: Decomposing Language Models With Dictionary Learning](https://transformer-circuits.pub/2023/monosemantic-features/) — Bricken et al. 2023 (Anthropic). Sparse autoencoder applied to a one-layer transformer to extract monosemantic features. The core methodology paper for this week (Transformer Circuits Thread, not arXiv).
...
[Toy Models of Superposition (Anthropic Transformer Circuits Thread)](https://transformer-circuits.pub/2022/toy_model/index.html) — The authoritative source for the superposition paper; Sections 1–3 give the key findings and examples that you should annotate before reading deeper sections.

[Understanding Anthropic’s Interpretability Research (Jack Clark)](https://jack-clark.net/2023/09/18/import-ai-340-drone-vs-human-drone-wins-adepts-small-but-good-ai-model-ai-succession/) — Import AI newsletter issue covering the monosemanticity paper; useful for framing the research program in context.
