...
- [GRPO in Practice: What Works and What Doesn't](https://www.interconnects.ai/p/papers-im-reading-base-model-rl-grpo) — Nathan Lambert. Lessons from running GRPO at various scales.
...
- [Open-Reasoner](https://github.com/Open-Reasoner-Zero/Open-Reasoner-Zero) — Another open RLVR training framework. Review for alternative GRPO configurations.
...
- [The Arithmetic of Compute for RLVR](https://cameronrwolfe.substack.com/p/grpo) — Community analysis of compute requirements for GRPO training at different scales. Use for planning your Week 50 iteration budget.
