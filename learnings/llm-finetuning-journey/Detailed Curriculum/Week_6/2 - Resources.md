...
- [Tokenization in Large Language Models](https://seantrott.substack.com/p/tokenization-in-large-language-models) — Sean Trott. Clear explainer on tokenization artifacts and why they matter for code generation.
