...
- [Defog SQLCoder model card and benchmark](https://defog.ai/blog/open-sourcing-sqlcoder2-7b) — Defog's approach and benchmark numbers; your primary competitor.
...
- [AlibabaResearch/DAMO-ConvAI](https://github.com/AlibabaResearch/DAMO-ConvAI) — Includes the DAIL-SQL implementation as a sub-project; study their eval harness for comparison.
- [bird-bench/mini_dev](https://github.com/bird-bench/mini_dev) — BIRD mini-dev set for quick iterations; 500 examples.
