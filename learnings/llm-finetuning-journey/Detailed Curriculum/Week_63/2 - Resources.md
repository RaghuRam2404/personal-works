...
[Unsloth GGUF Export Guide](https://unsloth.ai/docs/basics/inference-and-deployment/saving-to-gguf) — Official Unsloth documentation; covers the exact `save_pretrained_gguf` API and quantization type options used in your workflow.
...
[ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) — The reference GGUF inference engine; `quantize` binary and `convert_hf_to_gguf.py` are the tools you use this week.
...
[llama.cpp GGUF quantization types reference](https://github.com/ggml-org/llama.cpp/blob/master/tools/quantize/README.md) — Official table of all Q-types, their bit depth, and perplexity benchmarks on Llama models.
