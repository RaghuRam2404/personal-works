...
- [Let's Verify Step by Step (Lightman et al. 2023)](https://arxiv.org/abs/2305.20050) — Process reward models (PRMs) vs. outcome reward models (ORMs). Background for whether to reward intermediate reasoning steps.
...
- [Reward Hacking in RLHF: How to Detect and Prevent It](https://lilianweng.github.io/posts/2024-11-28-reward-hacking/) — HuggingFace. Practical guide to identifying reward hacking in LLM training. Read before finalizing your reward function.
- [Designing Reward Functions for Code Generation](https://www.swebench.com) — Analysis of reward design for code, analogous to SQL. Focus on the "execution-only vs semantic" tradeoff.
...
- [Beyond Verifiable Rewards: Scaling RL in LMs to Unverifiable Data (Tang et al. 2025)](https://arxiv.org/abs/2503.19618) — Empirical study of how GRPO performance scales with K, group size, and reward quality. Useful calibration for your reward design choices.
