...
- [Self-Rewarding Language Models](https://arxiv.org/abs/2401.10020) — Yuan et al. 2024. Uses the model itself to generate reward signals for preference data; background for understanding how synthetic preference pairs can be built from your SQL generator without human labelers.
...
- [Spider](https://yale-lily.github.io/spider) — 10K expert-labeled, cross-domain. Download from Yale NLP GitHub.
- [wikisql](https://huggingface.co/datasets/Salesforce/wikisql) — 80K simple single-table queries; good volume fallback.
...
- [Synthetic Data Generation for SQL: Best Practices](https://defog.ai/blog/sqlcoder2-technical-details) — Defog AI. Practical guide for generating SQL training data.
...
- [TimescaleDB documentation](https://www.tigerdata.com/docs//) — Reference for TimescaleDB-specific SQL functions; use when crafting hand-written examples.
