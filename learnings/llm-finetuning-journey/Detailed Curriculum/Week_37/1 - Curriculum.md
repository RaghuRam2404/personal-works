...
- [Spider](https://yale-lily.github.io/spider) — 10K expert-labeled, cross-domain. SQL style is standard; most queries are PostgreSQL-compatible.
- [WikiSQL](https://huggingface.co/datasets/Salesforce/wikisql) — 80K simple single-table queries. Lower complexity but good volume.
