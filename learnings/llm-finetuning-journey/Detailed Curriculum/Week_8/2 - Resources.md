...
- [Deep Reinforcement Learning that Matters](https://arxiv.org/abs/1709.06560) — Henderson et al., 2017. Although framed for RL, the lessons on random seeds, hyperparameter sensitivity, statistical significance, and honest reporting apply directly to your capstone self-assessment. Read Sections 4–5.
