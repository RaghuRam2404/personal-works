...
- [What Will It Take to Fix Benchmarking in NLP?](https://arxiv.org/abs/2104.02145) — Bowman & Dahl, 2021. Critical analysis of NLP benchmark limitations; directly applicable to thinking rigorously about Custom-200's weaknesses.
- [Utility is in the Eye of the User: A Critique of NLP Leaderboards (Ethayarajh & Jurafsky)](https://arxiv.org/abs/2009.13888) — Ethayarajh & Jurafsky, 2020. Argues that single-score leaderboards obscure important performance variation; motivates your per-stratum reporting on Custom-200.
...
- [Eugene Yan — Practical MLOps for the Individual Practitioner](https://eugeneyan.com/writing/practical-guide-to-maintaining-machine-learning/) — Blog post on what production ML looks like at a small scale; actionable for a single engineer deploying their own model.
...
- [Sebastian Ruder — Tracking Progress in NLP](https://www.ruder.io/tracking-progress-nlp/) — Regular summaries of significant NLP papers; useful for staying current after the course ends.
...
- [Weights & Biases — ML Engineering Roles Explained](https://wandb.ai/fully-connected/articles/ml-engineering-roles) — Breakdown of ML Engineer vs Applied Scientist vs Research Engineer; helps you target the right job title.
