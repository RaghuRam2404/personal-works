...
- [Utility is in the Eye of the User: A Critique of NLP Leaderboards (Ethayarajh & Jurafsky)](https://arxiv.org/abs/2009.13888) — Roelofs et al. 2020. How evaluation sets get "overfit" through repeated use; directly relevant to the Week 51 blind validation requirement.
...
- [HuggingFace Hub model versioning](https://huggingface.co/docs/hub/models-the-hub) — How to tag model versions on the Hub (e.g., tagging `phase5-best` as v0.5.0). Useful for Phase 6 version management.
- [W&B Compare Runs](https://docs.wandb.ai/models/app/features/panels/run-comparer) — How to create side-by-side run comparisons in W&B for your iteration experiments.

## Optional / Bonus

- [The ML Test Score: A Rubric for Production Readiness (Breck et al. 2017)](https://research.google.com/pubs/archive/45742.pdf) — Google. A checklist for production ML systems. As you approach Phase 6 deployment, this rubric becomes relevant.
