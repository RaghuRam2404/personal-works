...
- [Scaling Laws for Transfer](https://arxiv.org/abs/2102.01293) — Zhao et al. 2022. How fine-tuning scales differently from pretraining.
...
- [EleutherAI Scaling Laws post](https://epoch.ai/blog/chinchilla-scaling-a-replication-attempt) — EleutherAI's take on what the scaling law research actually implies.
...
- [EleutherAI/gpt-neox](https://github.com/EleutherAI/gpt-neox) — Production-grade pretraining codebase used to validate scaling-law predictions on Pythia checkpoints; useful reference for scaling experiments beyond nanoGPT.
...
- [Epoch AI: Scaling Laws Literature Review](https://epoch.ai/blog/scaling-laws-literature-review) — Pablo Villalobos. Curated database and review of scaling-law results across tasks and architectures; the most comprehensive overview if you want to go beyond Kaplan and Chinchilla.
