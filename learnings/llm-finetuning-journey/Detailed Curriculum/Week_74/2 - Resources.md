...
[Extending Context Length with YaRN (Nous Research blog)](https://huggingface.co/papers/2309.00071) — Practical YaRN implementation guide with code examples for HuggingFace models.

[Lost in the Middle: How Language Models Use Long Contexts (Liu et al. 2023)](https://arxiv.org/abs/2307.03172) — Tests whether long-context models actually use the full context; relevant for evaluating whether context extension improves SQL on large schemas.
...
[Towards Complex Text-to-SQL in Cross-Domain Database with Intermediate Representation (IRNet, Guo et al. 2019)](https://arxiv.org/abs/1905.08205) — The algorithmic basis for schema compression; automatically identifies relevant tables for a query using entity linking.
