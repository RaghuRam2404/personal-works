...
- [HuggingFace Deep RL Course — Introduction to Deep Reinforcement Learning (Unit 1)](https://www.youtube.com/watch?v=q0BiUn5LiBc) — Thomas Simonini (HuggingFace) — ~30 min. The first lecture in the Deep RL Course playlist; covers MDPs and the policy/value-based dichotomy that frames every method you used in Phase 5.
- [HuggingFace Deep RL Course — PPO from scratch with PyTorch (Unit 8)](https://www.youtube.com/watch?v=MEt6rrxH8W4) — Costa Huang via HuggingFace — ~1h35m. Direct walkthrough of the CleanRL-style PPO implementation that Week 42 built on; rewatch the clipped surrogate and value-function loss sections during gate remediation.
...
- [HuggingFace — ORPO: An Efficient LLM Alignment Approach](https://huggingface.co/blog/mlabonne/orpo-llama-3) — Concise explanation of the ORPO loss with code. Pairs with the ORPO paper for Week 49.
...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) — Quantized CPU/Metal inference. Relevant if you want to run your Phase 5 models locally on Apple Silicon without a GPU server.
